// Package-level i18n seam for the partners CLI per CONST-046.
//
...
//
// This mirrors cmd/i18n.go and cmd/model-verification/i18n.go — partners
// is a distinct `main` package, so it carries its own copy of the tiny
// seam rather than reaching into a sibling main package (which Go forbids
// anyway).
package main
