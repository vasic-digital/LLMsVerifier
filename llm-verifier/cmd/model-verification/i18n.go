// Package-level i18n seam for the model-verification CLI per CONST-046.
//
...
//
// This mirrors cmd/i18n.go — model-verification is a distinct `main`
// package, so it carries its own copy of the tiny seam rather than
// reaching into a sibling main package (which Go forbids anyway).
package main
