...
func printHelp() {
	fmt.Println(tr("code_verification.help.title"))
	fmt.Println()
	fmt.Println(tr("code_verification.help.summary"))
	fmt.Println()
	fmt.Println(tr("code_verification.help.usage_heading"))
	fmt.Println(tr("code_verification.help.usage_line"))
	fmt.Println()
	fmt.Println(tr("code_verification.help.options_heading"))
	fmt.Println(tr("code_verification.help.option_config"))
	fmt.Println(tr("code_verification.help.option_output"))
	fmt.Println(tr("code_verification.help.option_providers"))
	fmt.Println(tr("code_verification.help.option_models"))
	fmt.Println(tr("code_verification.help.option_concurrency"))
	fmt.Println(tr("code_verification.help.option_timeout"))
	fmt.Println(tr("code_verification.help.option_format"))
	fmt.Println(tr("code_verification.help.option_db"))
	fmt.Println(tr("code_verification.help.option_help"))
	fmt.Println()
	fmt.Println(tr("code_verification.help.examples_heading"))
	fmt.Println(tr("code_verification.help.example_all_comment"))
	fmt.Println(tr("code_verification.help.example_all_command"))
	fmt.Println()
	fmt.Println(tr("code_verification.help.example_providers_comment"))
	fmt.Println(tr("code_verification.help.example_providers_command"))
	fmt.Println()
	fmt.Println(tr("code_verification.help.example_models_comment"))
	fmt.Println(tr("code_verification.help.example_models_command"))
	fmt.Println()
	fmt.Println(tr("code_verification.help.example_output_comment"))
	fmt.Println(tr("code_verification.help.example_output_command"))
}
...
func printSummary(report VerificationReport) {
	fmt.Println("\n" + tr("code_verification.summary.heading"))
	fmt.Printf("%s %d\n", tr("code_verification.summary.total_models"), report.TotalModels)
	fmt.Printf("%s %d\n", tr("code_verification.summary.verified_models"), report.VerifiedModels)
	fmt.Printf("%s %d\n", tr("code_verification.summary.failed_models"), report.FailedModels)
	fmt.Printf("%s %d\n", tr("code_verification.summary.error_models"), report.ErrorModels)
	fmt.Printf("%s %.2f\n", tr("code_verification.summary.average_score"), report.AverageScore)
	fmt.Printf("%s %.1f%%\n", tr("code_verification.summary.success_rate"), float64(report.VerifiedModels)/float64(report.TotalModels)*100)
}
