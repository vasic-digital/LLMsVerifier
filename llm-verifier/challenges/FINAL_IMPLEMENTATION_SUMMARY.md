...
```bash
[2025-12-23 18:30:27] COMMAND: curl -s -H 'Authorization: Bearer ${HUGGINGFACE_API_KEY}' 'https://api-inference.huggingface.co/models'
...
[2025-12-23 18:30:33] COMMAND: curl -s -H 'Authorization: Bearer ${OPENROUTER_API_KEY}' 'https://openrouter.ai/api/v1/models'

[2025-12-23 18:30:35] COMMAND: curl -s -H 'Authorization: Bearer ${API_KEY}' 'https://api.deepseek.com/v1/models'
```
