// Package-level i18n seam for the enhanced library package per CONST-046.
//
...
// issue-template and report-writer signature. Consumers that link this
...
//
// This mirrors the llmverifier/i18n.go seam (round 316) so the migration
...
// translator is the active i18n backend for the enhanced package. Tests
...
// context and discards the error path — the issue-template / report
...
// trList resolves a slice of message IDs to their translated strings.
// Used by issue-template builders whose Symptoms/Workarounds fields are
// string slices.
func trList(ids ...string) []string {
