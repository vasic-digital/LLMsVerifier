...
type VulavulaAdapter struct {
	BaseAdapter
}

func NewVulavulaAdapter(client *http.Client, endpoint, apiKey string) *VulavulaAdapter {
	return &VulavulaAdapter{
...
func (p *VulavulaAdapter) StreamChatCompletion(ctx context.Context, request OpenAIChatRequest) (<-chan OpenAIStreamResponse, <-chan error) {
...
func (p *VulavulaAdapter) ChatCompletion(ctx context.Context, request OpenAIChatRequest) (*OpenAIChatResponse, error) {
	requestBody, err := json.Marshal(request)
	if err != nil {
...
func (p *VulavulaAdapter) ListModels(ctx context.Context) (*OpenAIModelsResponse, error) {
