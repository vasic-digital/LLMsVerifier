...
func NewNovitaAdapter(client *http.Client, endpoint, apiKey string) *NovitaAdapter {
...
func (p *NovitaAdapter) StreamChatCompletion(ctx context.Context, request OpenAIChatRequest) (<-chan OpenAIStreamResponse, <-chan error) {
...
func (p *NovitaAdapter) ChatCompletion(ctx context.Context, request OpenAIChatRequest) (*OpenAIChatResponse, error) {
	requestBody, err := json.Marshal(request)
	if err != nil {
...
func (p *NovitaAdapter) ListModels(ctx context.Context) (*OpenAIModelsResponse, error) {
