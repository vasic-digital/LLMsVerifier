...
type UpstageAdapter struct {
	BaseAdapter
}

func NewUpstageAdapter(client *http.Client, endpoint, apiKey string) *UpstageAdapter {
...
func (p *UpstageAdapter) StreamChatCompletion(ctx context.Context, request OpenAIChatRequest) (<-chan OpenAIStreamResponse, <-chan error) {
...
func (p *UpstageAdapter) ChatCompletion(ctx context.Context, request OpenAIChatRequest) (*OpenAIChatResponse, error) {
	requestBody, err := json.Marshal(request)
	if err != nil {
...
func (p *UpstageAdapter) ListModels(ctx context.Context) (*OpenAIModelsResponse, error) {
