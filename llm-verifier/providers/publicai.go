...
type PublicAIAdapter struct {
	BaseAdapter
}

func NewPublicAIAdapter(client *http.Client, endpoint, apiKey string) *PublicAIAdapter {
	return &PublicAIAdapter{
...
func (p *PublicAIAdapter) StreamChatCompletion(ctx context.Context, request OpenAIChatRequest) (<-chan OpenAIStreamResponse, <-chan error) {
...
func (p *PublicAIAdapter) ChatCompletion(ctx context.Context, request OpenAIChatRequest) (*OpenAIChatResponse, error) {
	requestBody, err := json.Marshal(request)
	if err != nil {
...
func (p *PublicAIAdapter) ListModels(ctx context.Context) (*OpenAIModelsResponse, error) {
