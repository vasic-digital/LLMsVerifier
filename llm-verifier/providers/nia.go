...
type NiaAdapter struct {
	BaseAdapter
}

func NewNiaAdapter(client *http.Client, endpoint, apiKey string) *NiaAdapter {
	return &NiaAdapter{
...
func (p *NiaAdapter) StreamChatCompletion(ctx context.Context, request OpenAIChatRequest) (<-chan OpenAIStreamResponse, <-chan error) {
...
func (p *NiaAdapter) ChatCompletion(ctx context.Context, request OpenAIChatRequest) (*OpenAIChatResponse, error) {
	requestBody, err := json.Marshal(request)
	if err != nil {
...
func (p *NiaAdapter) ListModels(ctx context.Context) (*OpenAIModelsResponse, error) {
