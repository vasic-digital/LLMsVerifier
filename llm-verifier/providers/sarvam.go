...
func NewSarvamAdapter(client *http.Client, endpoint, apiKey string) *SarvamAdapter {
...
func (p *SarvamAdapter) StreamChatCompletion(ctx context.Context, request OpenAIChatRequest) (<-chan OpenAIStreamResponse, <-chan error) {
...
func (p *SarvamAdapter) ChatCompletion(ctx context.Context, request OpenAIChatRequest) (*OpenAIChatResponse, error) {
	requestBody, err := json.Marshal(request)
	if err != nil {
...
func (p *SarvamAdapter) ListModels(ctx context.Context) (*OpenAIModelsResponse, error) {
