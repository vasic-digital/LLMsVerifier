...
type NLPCloudAdapter struct {
	BaseAdapter
}

func NewNLPCloudAdapter(client *http.Client, endpoint, apiKey string) *NLPCloudAdapter {
	return &NLPCloudAdapter{
...
func (p *NLPCloudAdapter) StreamChatCompletion(ctx context.Context, request OpenAIChatRequest) (<-chan OpenAIStreamResponse, <-chan error) {
...
func (p *NLPCloudAdapter) ChatCompletion(ctx context.Context, request OpenAIChatRequest) (*OpenAIChatResponse, error) {
	requestBody, err := json.Marshal(request)
	if err != nil {
...
func (p *NLPCloudAdapter) ListModels(ctx context.Context) (*OpenAIModelsResponse, error) {
