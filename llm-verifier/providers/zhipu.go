...
func NewZhipuAdapter(client *http.Client, endpoint, apiKey string) *ZhipuAdapter {
	return &ZhipuAdapter{
...
func (p *ZhipuAdapter) StreamChatCompletion(ctx context.Context, request OpenAIChatRequest) (<-chan OpenAIStreamResponse, <-chan error) {
...
func (p *ZhipuAdapter) ChatCompletion(ctx context.Context, request OpenAIChatRequest) (*OpenAIChatResponse, error) {
	requestBody, err := json.Marshal(request)
	if err != nil {
...
func (p *ZhipuAdapter) ListModels(ctx context.Context) (*OpenAIModelsResponse, error) {
