...
func NewKiloAdapter(client *http.Client, endpoint, apiKey string) *KiloAdapter {
	return &KiloAdapter{
...
func (p *KiloAdapter) StreamChatCompletion(ctx context.Context, request OpenAIChatRequest) (<-chan OpenAIStreamResponse, <-chan error) {
...
func (p *KiloAdapter) ChatCompletion(ctx context.Context, request OpenAIChatRequest) (*OpenAIChatResponse, error) {
	requestBody, err := json.Marshal(request)
	if err != nil {
...
func (p *KiloAdapter) ListModels(ctx context.Context) (*OpenAIModelsResponse, error) {
