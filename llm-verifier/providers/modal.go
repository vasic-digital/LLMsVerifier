...
func NewModalAdapter(client *http.Client, endpoint, apiKey string) *ModalAdapter {
	return &ModalAdapter{
...
func (p *ModalAdapter) StreamChatCompletion(ctx context.Context, request OpenAIChatRequest) (<-chan OpenAIStreamResponse, <-chan error) {
...
func (p *ModalAdapter) ChatCompletion(ctx context.Context, request OpenAIChatRequest) (*OpenAIChatResponse, error) {
	requestBody, err := json.Marshal(request)
	if err != nil {
...
func (p *ModalAdapter) ListModels(ctx context.Context) (*OpenAIModelsResponse, error) {
