...
func GetFallbackModels(providerID string) []Model {
	...
	commonModels := map[string][]Model{
		...
		"cloudflare": {
			{ID: "@cf/meta/llama-4-scout-17b-16e-instruct", Name: "Llama 4 Scout", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/meta/llama-3.3-70b-instruct-fp8-fast", Name: "Llama 3.3 70B FP8 Fast", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/meta/llama-3.1-70b-instruct", Name: "Llama 3.1 70B Instruct", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/meta/llama-3.1-8b-instruct-fast", Name: "Llama 3.1 8B Fast", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/meta/llama-3.1-8b-instruct", Name: "Llama 3.1 8B Instruct", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/nvidia/nemotron-3-120b-a12b", Name: "Nemotron 3 120B", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/openai/gpt-oss-120b", Name: "GPT OSS 120B", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/mistral/mistral-small-3.1-24b-instruct", Name: "Mistral Small 3.1 24B", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/google/gemma-3-12b-it", Name: "Gemma 3 12B IT", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/qwen/qwq-32b", Name: "Qwen QwQ 32B", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/qwen/qwen2.5-coder-32b-instruct", Name: "Qwen 2.5 Coder 32B", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/deepseek/deepseek-r1-distill-qwen-32b", Name: "DeepSeek R1 Distill 32B", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
			{ID: "@cf/zai/glm-4.7-flash", Name: "GLM 4.7 Flash", ProviderID: "cloudflare", ProviderName: "Cloudflare", MaxTokens: 131072},
		},
		"qwen": {
