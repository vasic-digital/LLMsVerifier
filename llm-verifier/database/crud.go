...
func (d *Database) GetVerificationResult(id int64) (*VerificationResult, error) {
	...
	verificationResult.CompletedAt = scanNullableTimeFromString(completedAt)
	verificationResult.ErrorMessage = scanNullableString(errorMessage)
	verificationResult.Exists = scanNullableBoolFromString(exists)
	verificationResult.Responsive = scanNullableBoolFromString(responsive)
	verificationResult.Overloaded = scanNullableBoolFromString(overloaded)
