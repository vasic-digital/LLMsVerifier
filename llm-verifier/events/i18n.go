// Package-level i18n seam for the events package per CONST-046.
//
// translator is a package-level variable so event-publishing call sites can
// be migrated incrementally without threading a Translator argument through
// every CreateEvent title/message assignment. Consumers that link this
// package directly may override the variable at init time; the default
...
//
// This mirrors the llmverifier/i18n.go, enhanced/i18n.go and monitoring/
// i18n.go seams (rounds 316 / 319 / 326) so the migration pattern stays
// uniform across binary and library packages.
package events
...
// translator is the active i18n backend for the events package. Tests in
