...
This Constitution inherits the universal mandatory development constraints
defined for every project in the HelixAgent ecosystem. The block below is
the canonical text and is mirrored verbatim into `CLAUDE.md` and
`AGENTS.md`. Project-specific addenda may extend these rules but cannot
