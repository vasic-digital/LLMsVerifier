// Package-level i18n seam for the llmops package per CONST-046.
//
...
// to the llm-verifier seams (rounds 316 / 319 / 326 / 328 / 332) so the
// migration pattern stays uniform across the two modules.
//
...
// Translator is the minimal i18n surface every llmops call site uses.
...
// translator is the active i18n backend for the llmops package. Tests in
