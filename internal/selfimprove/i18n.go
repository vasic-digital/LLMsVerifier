// Package-level i18n seam for the selfimprove package per CONST-046.
//
...
// to the llmops and benchmark seams so the migration pattern stays uniform
// across every module in the codebase.
//
// translator is a package-level variable so log / description call sites
// can be migrated incrementally without threading a Translator argument
// through every constructor. Consumers that link this package directly may
...
// Translator is the minimal i18n surface every selfimprove call site uses.
...
// translator is the active i18n backend for the selfimprove package. Tests
